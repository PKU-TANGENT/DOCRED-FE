...
def create_model(model_class: BertPreTrainedModel, encoder_config: BertConfig, tokenizer: BertTokenizer,
                 ...
                 position_embeddings_count: int = 700, cache_path=None, use_f_entity_type = False, use_semantic_entity_embedding = False):
    params = dict(config=encoder_config,
                  ...
                  use_f_entity_type = use_f_entity_type, 
                  use_semantic_entity_embedding = use_semantic_entity_embedding
                  )
