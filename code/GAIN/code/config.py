...
def get_opt():
    ...
    parser.add_argument('--entity_type_num', type=int, default=120)
    ...
    parser.add_argument('--entity_type_size', type=int, default=64) # 是否使用entity_type 这个参数，如果使用的话，就将其设置成20的embedding
    ...
    # 理解一下这个参数的作用
    parser.add_argument('--gcn_dim', type=int, default=852)
